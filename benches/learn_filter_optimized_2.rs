...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_0_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_0_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_0_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_0_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_0_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_0_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![(((phv_containers[0].get_value()==0))) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_1_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_1_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+phv_containers[0].get_value();
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_1_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_1_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![(((phv_containers[0].get_value()==0))) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_1_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_1_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![(((phv_containers[0].get_value()==0))) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_2_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = state_vec[0]+2;
    (old_state, state_vec.clone())
    };
    Box::new(alu)
}
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_2_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_2_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_2_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_2_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
      if phv_containers[0].get_value()!=0 {
        (vec![(phv_containers[1].get_value()) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_2_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![((phv_containers[0].get_value()==phv_containers[1].get_value())) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_3_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = state_vec[0]+3;
    (old_state, state_vec.clone())
    };
    Box::new(alu)
}
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_3_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+3;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_3_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = state_vec[0]+2;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_3_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![((phv_containers[0].get_value()>=phv_containers[1].get_value())) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_3_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![(((phv_containers[0].get_value()==0))) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_3_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
      if phv_containers[0].get_value()!=0 {
        (vec![(phv_containers[1].get_value()) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_4_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = state_vec[0]+3;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_4_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+1;
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateful_alu_4_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = 0+phv_containers[0].get_value();
    (old_state, state_vec.clone())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_4_0(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        (vec![(((phv_containers[0].get_value()==0))) as i32], Vec::new())
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_4_1(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
...
pub fn init_learn_filter_equivalent_1_canonicalizer_equivalent_0_raw_stateless_alu_5_3_stateless_alu_4_2(_hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    // state_vec unused
    let alu = move |_state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
...
pub fn init_pipeline (_h : HashMap <String, i32>) -> Pipeline { 
  ...
  let pipeline_stage_4 : PipelineStage = PipelineStage {stateful_atoms : stateful_alus_4, stateless_atoms : stateless_alus_4 , salu_configs : salu_configs_4, output_mux_globals : output_mux_globals_4, state_container : Vec::new() };
