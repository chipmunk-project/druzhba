...
fn simple_raw_stateless_alu_2_2_stateful_alu_0_0_const_0 (constant : i32) -> i32 {
  constant
}
pub fn init_simple_raw_stateless_alu_2_2_stateful_alu_0_0(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    ...
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = simple_raw_stateless_alu_2_2_stateful_alu_0_0_Opt_0(state_vec[0], hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_0_0_Opt_0_global"])+simple_raw_stateless_alu_2_2_stateful_alu_0_0_Mux2_0(phv_containers[0].get_value(), simple_raw_stateless_alu_2_2_stateful_alu_0_0_const_0(hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_0_0_const_0_global"]), hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_0_0_Mux2_0_global"]);
    (old_state, state_vec.clone())
    };
    Box::new(alu)
}
pub fn init_simple_raw_stateless_alu_2_2_stateless_alu_0_0(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        if hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_0_opcode"]==0 {
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_0_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(phv_containers[0].get_value()+hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_0_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_0_immediate"]-phv_containers[0].get_value()) as i32], Vec::new())
        }
        ...
        (vec![(((phv_containers[0].get_value()!=0)||(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_0_immediate"]!=0))) as i32], Vec::new())
        }
...
pub fn init_simple_raw_stateless_alu_2_2_stateless_alu_0_1(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        if hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_1_opcode"]==0 {
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_1_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(phv_containers[0].get_value()+hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_1_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_1_immediate"]-phv_containers[0].get_value()) as i32], Vec::new())
        }
        ...
        (vec![(((phv_containers[0].get_value()!=0)||(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_0_1_immediate"]!=0))) as i32], Vec::new())
        }
...
fn simple_raw_stateless_alu_2_2_stateful_alu_1_0_const_0 (constant : i32) -> i32 {
  constant
}
pub fn init_simple_raw_stateless_alu_2_2_stateful_alu_1_0(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
    let old_state : Vec<i32> = state_vec.clone();
        state_vec[0] = simple_raw_stateless_alu_2_2_stateful_alu_1_0_Opt_0(state_vec[0], hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_1_0_Opt_0_global"])+simple_raw_stateless_alu_2_2_stateful_alu_1_0_Mux2_0(phv_containers[0].get_value(), simple_raw_stateless_alu_2_2_stateful_alu_1_0_const_0(hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_1_0_const_0_global"]), hole_vars["simple_raw_stateless_alu_2_2_stateful_alu_1_0_Mux2_0_global"]);
    (old_state, state_vec.clone())
    };
    Box::new(alu)
}
pub fn init_simple_raw_stateless_alu_2_2_stateless_alu_1_0(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        if hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_0_opcode"]==0 {
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_0_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(phv_containers[0].get_value()+hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_0_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_0_immediate"]-phv_containers[0].get_value()) as i32], Vec::new())
        }
        ...
        (vec![(((phv_containers[0].get_value()!=0)||(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_0_immediate"]!=0))) as i32], Vec::new())
        }
...
pub fn init_simple_raw_stateless_alu_2_2_stateless_alu_1_1(hole_vars : HashMap <String, i32>) -> Box <dyn Fn (&mut Vec <i32>, &Vec <PhvContainer <i32>>) -> (Vec <i32>, Vec <i32> ) >{
    let alu = move |state_vec : &mut Vec <i32>, phv_containers : &Vec <PhvContainer <i32>>| -> (Vec <i32>, Vec <i32>){
        if hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_1_opcode"]==0 {
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_1_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(phv_containers[0].get_value()+hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_1_immediate"]) as i32], Vec::new())
        }
        ...
        (vec![(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_1_immediate"]-phv_containers[0].get_value()) as i32], Vec::new())
        }
        ...
        (vec![(((phv_containers[0].get_value()!=0)||(hole_vars["simple_raw_stateless_alu_2_2_stateless_alu_1_1_immediate"]!=0))) as i32], Vec::new())
        }
...
pub fn init_pipeline (hole_vars : HashMap <String, i32>) -> Pipeline { 
  ...
  let stateless_output_mux_0_0 : OutputMux = OutputMux { input_phv_containers : Vec::new(), index : hole_vars["simple_raw_stateless_alu_2_2_output_mux_phv_0_0_ctrl"]};
  ...
  let stateless_output_mux_0_1 : OutputMux = OutputMux { input_phv_containers : Vec::new(), index : hole_vars["simple_raw_stateless_alu_2_2_output_mux_phv_0_1_ctrl"]};
  ...
  let salu_configs_0 : Vec <i32> = vec![hole_vars["simple_raw_stateless_alu_2_2_salu_config_0_0"]];
  ...
  let stateless_output_mux_1_0 : OutputMux = OutputMux { input_phv_containers : Vec::new(), index : hole_vars["simple_raw_stateless_alu_2_2_output_mux_phv_1_0_ctrl"]};
  ...
  let stateless_output_mux_1_1 : OutputMux = OutputMux { input_phv_containers : Vec::new(), index : hole_vars["simple_raw_stateless_alu_2_2_output_mux_phv_1_1_ctrl"]};
  ...
  let salu_configs_1 : Vec <i32> = vec![hole_vars["simple_raw_stateless_alu_2_2_salu_config_1_0"]];
