...
#include "mtag-data/headers.p4"
#include "mtag-data/parser.p4"
#include "mtag-data/actions.p4"  // For actions marked "common_"
...
table identify_port {
    ...
    actions { // Each table entry specifies *one* action
        ...
        do_nothing;       // Allow packet to continue
    }
...
table select_output_port {
    ...
    actions {
        ...
        use_mtag_down1;
        use_mtag_down2;
        do_nothing; // If port type is not recognized, previous policy applied
    }
